> **ARŞİV — v1 (17 Ağustos 2026, Rlay Week challenge sürümü).** Geçerli spec: [`../SPEC.md`](../SPEC.md) (v2, 2 Eylül 2026). Bu dosya tarihsel referans; Ağalık, pot ve sayaçlı fazlar v2'de kaldırıldı.
